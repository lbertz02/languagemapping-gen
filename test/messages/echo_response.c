...
/** Information Elements in echo_response */
struct parse_echo_response_t {
	gtpv2c_ie *recovery;
...
static int
parse_echo_response(gtpv2c_header *gtpv2c_rx,
          struct parse_echo_response_t *er)
{
...
int
process_echo_response(gtpv2c_header *gtpv2c_rx,
